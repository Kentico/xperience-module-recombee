<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_Membership_FormControls_Users_MultipleCategoriesSelector"  Codebehind="MultipleCategoriesSelector.ascx.cs" %>
