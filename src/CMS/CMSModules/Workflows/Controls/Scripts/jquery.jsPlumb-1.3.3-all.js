...
(function() {
    ...
    */
    ...
    var jsPlumbInstance = function(_defaults) {
        ...
        */
        this.addEndpoint = function(el, params, referenceParams) {
            ...
            p.paintStyle = p.paintStyle || (p.endpoint[1] && p.endpoint[1].paintStyle) || _currentInstance.Defaults.EndpointStyle || jsPlumb.Defaults.EndpointStyle; //CMS EDIT
        ...
        */
        var Endpoint = function(params) {
            ...
            */
            ...
            {
                this.attachedAnchors = Array.isArray(params.attachedAnchors) ? new DynamicAnchor(jsPlumb.makeAnchors(params.attachedAnchors)) : jsPlumb.makeAnchor(params.attachedAnchors);
            ...
            this.toggleClass = function(cls, addOrRemove) { //CMS EDIT - added the second parameter
                var canvasJQ = self.getCanvasJQ();
                canvasJQ.toggleClass(cls, addOrRemove);
            };
    ...
    var _curryAnchor = function(x, y, xOrientation, yOrientation) {
        return function() {
            return jsPlumb.makeAnchor(x, y, xOrientation, yOrientation);
        };
    };
    ...
    jsPlumb.Endpoints.Image = function(params) {
        ...
        this.paint = function(d, style, anchor) {
            if (self.ready) {
                ...
                }, 1000 / 60); // CMS EDIT - better response time
            }
        };
    };
...
;(function() {
    ...
    var SvgEndpoint = function(params) {
        ...
        this._paint = function(d, style) {
            ...
            if (self.node == null) {
                ...
                /* CMS EDIT - Endpoint icons for marketing automation (SVG) */
                if (s.icon) {
                    self.icon = self.drawIcon(s.icon);
                    self.svg.appendChild(self.icon);
                }
                /* CMS EDIT END */
            }
    ...
    jsPlumb.Endpoints.svg.Dot = function() {
        ...
        /* CMS EDIT - Endpoint icons for marketing automation */
        this.drawIcon = function(icon) {
            var group = _node("g", { stroke: "white", "stroke-width": 2 });

            switch (icon) {
                case "case":
                    group.appendChild(_node("line", {
                        x1: 4,
                        y1: 8,
                        x2: 7,
                        y2: 11
...
// ********************************* CANVAS RENDERERS FOR CONNECTORS AND ENDPOINTS *******************************************************************
    ...
    var CanvasEndpoint = function(params) {
        ...
        this.paint = function(d, style, anchor) {
            jsPlumb.sizeCanvas(self.canvas, d[0], d[1], d[2] + 2, d[3] + 2); //CMS EDIT - make the canvas bigger so the inside element fits in it
    ...
    jsPlumb.Endpoints.canvas.Dot = function(params) {
        ...
        /* CMS EDIT - Endpoint icons for marketing automation */
        var drawIcon = function(ctx, type) {
            switch(type) {
                case "case":
                    ctx.beginPath();
                    ctx.moveTo(5, 9);
        ...
        this._paint = function(d, style, anchor) {
            if (style != null && params._jsPlumb.jsPlumbFillCanvases) {	 //CMS EDIT - optimization
                ...
                ctx.beginPath();
                ctx.arc(d[4] + 1, d[4] + 1, d[4], 0, Math.PI*2, true); //CMS EDIT - move the circle so it fits in the canvas
                ctx.closePath();
                if (style.fillStyle || style.gradient) ctx.fill();
                if (style.strokeStyle) ctx.stroke();
                /* CMS EDIT - Endpoint icons for marketing automation (Canvas) */
                if (style.icon) {
                    ctx.lineWidth = 2;
...
(function($) {
    ...
    jsPlumb.CurrentLibrary = {
        ...
        extend : function(o1, o2) {
            /* CMS EDIT - use our own $cmsj instead of regular jQuery */
            return $cmsj.extend(o1, o2);
            /* CMS EDIT END */
        },
        ...
        getElementObject : function(el) {
            /* CMS EDIT - use our own $cmsj instead of regular jQuery */
            return typeof(el)=='string' ? $cmsj("#" + el) : $cmsj(el);
            /* CMS EDIT END */
        },
...
/* CMS EDIT - use our own $cmsj instead of regular jQuery */
    $cmsj(document).ready(jsPlumb.init);
